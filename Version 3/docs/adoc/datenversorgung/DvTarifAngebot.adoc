...
+++</div>+++
 ...
 a|
WARNING: Deprecated:	Wird in künftigen Definitionen für DvTarifAngebot nicht mehr enthalten sein.
...
+++</div>+++
 ...
 a|
ID des Relationscodes, über den der Ortspunkt mit einem oder mehreren Tarifpunkten verknüpft ist.
Damit wird eine Haltestelle z.B. verschiedenen Tarif-Zonen zugeordnet.
...
+++</div>+++
 ...
 a|
X-Koordinate der globalen Position des Ortspunktes.
...
Zu jedem Eintrag in OrtspunkteKA muss auch ein referenzierender Datensatz in Ortspunkte existieren.
...
Zu jedem Eintrag in OrtspunkteTG muss auch ein referenzierender Datensatz in Ortspunkte existieren.
...
Ein Tarifpunkt wird über Relationscodes einer oder mehrerer Haltestellen (Ortspunkte) zugeordnet.
